...
HF_REPO = "canvit/canvitb16-add-vpe-pretrain-g128px-s512px-in21k-dv3b16-2026-02-02"
...
def _extract_config(model) -> dict:
    ...
    return {
        ...
        "n_backbone_registers": model.cfg.n_backbone_registers,
        "rw_stride": model.cfg.rw_stride,
        "enable_reads": model.cfg.enable_reads,
